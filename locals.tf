...
locals {
  region_arr        = var.region != "" ? split("-", var.region) : ["", "", ""]
  region            = var.region != "" ? format("%s%s%s", lower(local.region_arr[0]), lower(substr(local.region_arr[1], 0, 2)), lower(local.region_arr[2])) : ""
